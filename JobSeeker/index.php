    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="./searchjob/searchjob.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa-solid fa-briefcase" style="padding-right:10px"></i>Search Job</a>
